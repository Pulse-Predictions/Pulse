...
export function AIMarketAnalytics({
  ...
  if (loading) {
    return (
      <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/10 border border-blue-200 rounded-lg p-6">
        ...
        <div className="space-y-3">
          ...
          <div className="h-4 bg-blue-200/50 rounded animate-pulse w-full"></div>
          <div className="h-4 bg-blue-200/50 rounded animate-pulse w-2/3"></div>
        </div>
      </div>
    );
  }
...
export function AISignalBadge({
  ...
  return (
    <div className="inline-flex items-center gap-1.5 px-2 py-1 bg-blue-50 border border-blue-200 rounded-full">
